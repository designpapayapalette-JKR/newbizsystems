          ...
          <div className="lg:col-span-1 space-y-4">
            ...
            <Card>
              <CardContent className="py-3 flex gap-2">
                <Link href={`/leads/${lead.id}/invoices`} className="flex-1 text-center text-sm text-primary hover:underline">Invoices</Link>
                <span className="text-border">|</span>
                <Link href={`/leads/${lead.id}/payments`} className="flex-1 text-center text-sm text-primary hover:underline">Payments</Link>
              </CardContent>
            </Card>
          </div>
