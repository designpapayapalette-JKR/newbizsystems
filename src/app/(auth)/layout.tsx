    ...
    <div className="min-h-screen bg-white flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-zinc-950 p-12 flex-col justify-between relative overflow-hidden">
        ...
        <div className="relative z-10 flex items-center gap-2">
          <img src="/logo-full.png" alt="NewBiz Systems" className="h-8 w-auto brightness-0 invert" />
        </div>
        
        <div className="relative z-10 max-w-lg">
          <blockquote className="space-y-4">
            <p className="text-3xl font-medium text-white/90 leading-snug">
              &quot;The most intuitive way to manage your leads, track conversations, and close deals faster.&quot;
            </p>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-white">
        <div className="w-full max-w-[380px]">
          ...
          <div className="flex lg:hidden items-center gap-2 mb-10 justify-center">
            <img src="/logo-compact.png" alt="NewBiz Systems" className="h-8 w-auto" />
          </div>
