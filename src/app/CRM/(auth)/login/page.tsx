    ...
    <form onSubmit={handleLogin} className="space-y-5">
      ...
      <div className="space-y-2">
        <div className="flex items-center justify-between">
          ...
          <Link href="/CRM/forgot-password" className="text-sm text-zinc-500 hover:text-zinc-900 transition-colors">
            Forgot password?
          </Link>
        </div>
        <Input
    ...
    <div className="flex flex-col gap-6 w-full">
      ...
      <div className="mt-4 text-center">
        <p className="text-sm text-muted-foreground">
          ...
          <Link href="/CRM/signup" className="text-zinc-900 font-medium hover:underline focus:outline-none transition-colors">
            Sign up for free
          </Link>
        </p>
      </div>
