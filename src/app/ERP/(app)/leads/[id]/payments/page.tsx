  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="flex-1 overflow-y-auto p-4">
        <Link href={`/ERP/leads/${id}`} className="inline-flex items-center gap-1 text-sm text-muted-foreground hover:text-foreground mb-4">
                ...
                <div key={p.id} className="bg-white rounded-lg border p-4 flex flex-col sm:flex-row sm:items-center gap-3">
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex flex-wrap gap-3 text-xs text-muted-foreground">
                      {(p as any).invoice && (
                        <Link href={`/ERP/invoices/${(p as any).invoice.id}`} className="hover:text-primary">
