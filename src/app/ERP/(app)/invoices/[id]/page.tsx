  ...
  return (
    <div className="flex flex-col h-full">
        ...
        actions={
          <div className="flex gap-2">
            <Button asChild variant="outline" size="sm">
              <Link href={`/ERP/invoices/${id}/preview`}>
      ...
      <div className="flex-1 overflow-y-auto p-4">
        <Link href="/ERP/invoices" className="inline-flex items-center gap-1 text-sm text-muted-foreground hover:text-foreground mb-4">
