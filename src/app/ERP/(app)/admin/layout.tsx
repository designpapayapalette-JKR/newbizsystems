...
const adminNav = [
  { href: "/ERP/admin", label: "Overview" },
  { href: "/ERP/admin/organizations", label: "Organizations" },
  { href: "/ERP/admin/plans", label: "Subscription Plans" },
  { href: "/ERP/admin/users", label: "Users" },
  { href: "/ERP/admin/support", label: "Support Tickets" },
];
