  ...
  try {
    ...
    return (
      <div className="p-8 text-center space-y-4">
        <h1 className="text-xl font-bold text-red-600">Something went wrong on the Payroll page</h1>
        <div className="bg-red-50 p-4 rounded text-xs text-red-800 font-mono text-left max-w-2xl mx-auto overflow-auto">
          {error.message || "Unknown error"}
          <br />
          {error.stack}
        </div>
        <p className="text-sm text-gray-500">Please share this error with support.</p>
      </div>
    );
  }
}
