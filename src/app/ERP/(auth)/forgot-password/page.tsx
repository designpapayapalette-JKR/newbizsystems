  ...
  if (sent) {
    return (
      <div className="flex flex-col items-center justify-center space-y-4 text-center">
        ...
        <div className="pt-4">
          <Link href="/ERP/login" className="inline-flex items-center text-sm font-medium text-zinc-900 hover:text-zinc-700 transition-colors">
  ...
  return (
    <div className="flex flex-col gap-6 w-full">
      ...
      <div className="mt-4 text-center">
        <Link href="/ERP/login" className="inline-flex items-center text-sm font-medium text-zinc-500 hover:text-zinc-900 transition-colors">
          <ArrowLeft className="mr-2 h-4 w-4" />
          Back to login
        </Link>
      </div>
